    ...
    <button
      ...
      className={cn(
        ...
        type === "primary"
          ...
          : type === "secondary"
          ? "bg-green-primary bg-opacity-10 hover:bg-opacity-20 ring-green-primary text-green-primary ring-opacity-10 border border-black-primary border-opacity-10 h-[56px]"
          : type === "cancel"
